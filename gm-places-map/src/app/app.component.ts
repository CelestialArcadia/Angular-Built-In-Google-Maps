...
import { Component, ChangeDetectionStrategy, OnInit, Inject, ChangeDetectorRef, NgZone } from "@angular/core";
...
export class AppComponent implements OnInit {
  ...
  private async checkGmApiKey() {
    if (localStorage.getItem('gm_api_key')) {
      if (
        new Date(
          localStorage.getItem('gm_api_key_expires_in') as string
        ...
        await this.loadScript(
          this.getScript(localStorage.getItem('gm_api_key') as string)
        );
        this.scriptLoaded = true;
      }
    }
